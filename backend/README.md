...
- Pendientes de entrega: publicación del incremento y revisión con el equipo. Verificación/recuperación real y reglas de operaciones futuras permanecen fuera de esta implementación. No se envían correos de verificación ni se aceptan términos legales definitivos. El acceso básico ya no requiere activación.
