...
export function HowItWorksPage() {
  return <>
    ...
    <section className={styles.hero}><h2>¿Listo para descubrir una buena idea?</h2><p>Explora las campañas de ejemplo y conoce su historia. El registro, la sesión, el perfil y las organizaciones en borrador están conectados a la base de pruebas. Las campañas siguen simuladas y esta versión no recibe aportes ni procesa pagos.</p><div className={styles.actions}><ButtonLink to="/explorar">Explorar proyectos</ButtonLink><ButtonLink variant="secondary" to="/registro">Crear una cuenta</ButtonLink></div></section>
  </>
}
